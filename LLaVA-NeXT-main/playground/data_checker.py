...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_path", type=str, default="./scripts/i18n/scale_llms/next_continual.yaml")
    parser.add_argument("--image_root", type=str, default="./data/llava_data")
    parser.add_argument("--video_root", type=str, default="./data/llava_video")
