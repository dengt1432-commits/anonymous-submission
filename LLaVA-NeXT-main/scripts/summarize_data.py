...
with open("./playground/data/llava_instruct_150k.json") as f:
...
with open("./playground/data/mixtral_instruct_135K_of_158K_V1.5.json") as f:
...
#                 all_conv += cur_conversation["value"]
#         # if not os.path.exists(f'./data/{_["image"]}'):
#             import pdb; pdb.set_trace()

# Write new_data to a new JSON file
with open("./playground/data/llava_v1_5_mix665k_minus_llava_instruct_150k_minus_sharegpt_plus_mixtral_instruct_135K_of_158K_V1.5.json", "w") as f:
