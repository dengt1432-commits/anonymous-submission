...
def main():
    ...
    parser.add_argument("--images_folder", type=str, default="./data/llava_data", help="Path to the folder containing images.")
    ...
    plt.tight_layout()
    plt.savefig(f"./notebooks/sft_data/dist_{llava_instruct_name}_combined.png")
    print(f"Plots saved to ./notebooks/sft_data/dist_{llava_instruct_name}_combined.png")
