...
json_path = "./data/vlfeedback_80k.jsonl"
...
for dimension in ["Visual Faithfulness", "Helpfulness", "Ethical Considerations"]:
    ...
    with open(f"./data/llava_instruct/dpo_data/silkie_dpo_data_{dimension.replace(' ', '_').lower()}_{len(converted_data)}.json", "w") as f:
